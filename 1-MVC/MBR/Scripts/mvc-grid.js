    ...
    MvcGridFilter.prototype = {
        ...
        renderFilter: function (grid, filter, lang) {
            ...
            return '<div class="popup-group">' +
                       '<select class="mvc-grid-method selectpicker" data-live-search="true" data-live-search-placeholder="Buscar" data-actions-box="true">' +
                            methods +
                       '</select>' +
                   '</div>' +
                   ...
                   (hasOptions ?
                       '<select class="mvc-grid-value selectpicker" data-live-search="true" data-live-search-placeholder="Buscar" data-actions-box="true" title="Vencimento">' + filter.options.html() + '</select>' :
                       '<input class="mvc-grid-value selectpicker" data-live-search="true" data-live-search-placeholder="Buscar" data-actions-box="true" title="Vencimento" />') +
                   '</div>'
                   :
                   '');
        },
